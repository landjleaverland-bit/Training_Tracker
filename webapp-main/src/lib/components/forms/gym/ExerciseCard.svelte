<script lang="ts">
	...
	export let benchmarks: Array<{ date: string; difficulty: string; weight: number; reps: number }> =
		[];
	...
	<div class="header">
		<div class="title-group">
			...
			<div>
				...
				<!-- Timer Button -->
				<button
					class="icon-btn timer-btn"
					on:click={() => dispatch('timer', exercise)}
				...
				<div class="benchmarks">
					{#each benchmarks as target}
						<div
							class="benchmark-pill"
							class:has-data={true}
							style="--pill-color: var(--color-{target.difficulty.toLowerCase()})"
		...
		<button
			...
			aria-label="Delete Exercise">🗑️</button
		>
	</div>
